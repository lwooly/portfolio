...
const AboutMe = () => {
  return (
    <Stack sx={{ flexDirection:{xs:'column', md: 'row'}}} className="about-me">
      <AboutMeImage />
      <Box sx={{flex: 2}}>
        ...
        <Typography variant="body2">
          ...
          now delving into the realms of software development, keen on
          integrating engineering problem solving ability with modern tech
          stacks. Currently, I&apos;m deeply engaged in learning and applying
          ...
          Through this journey, I aim to bring a unique perspective to software
          development, solving complex problems with a blend of structural
